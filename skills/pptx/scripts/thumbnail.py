...
Requirements:
    pip install Pillow defusedxml python-pptx
...
def _get_soffice_cmd() -> str:
    """Return the LibreOffice soffice command for the current platform."""
    ...
    if system == "Windows":
        ...
        return mac_path if os.path.exists(mac_path) else "soffice"
    else:
        return "soffice"


def run_soffice(args: list, **kwargs):
    cmd = [_get_soffice_cmd()] + args
